#!/usr/bin/env python3
"""
Paper Trading Bot — Coin Liquidity Analyzer
Replicates kalkulator.html analysis logic and paper-trades on 15m and 1h timeframes.
"""
...
_CFG_OVERRIDE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "paper_bot_config.json")
...
def main():
    log("Paper Trading Bot starting...")
