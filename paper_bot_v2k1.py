...
_CFG_OVERRIDE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "paper_bot_v2k1_config.json")
...
DATA_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "paper_trades_v2k1.json")
    ...
    while True:
        try:
            ...
            if minute % 5 == 0:
                try:
                    import subprocess
                    subprocess.run(["git", "add", "paper_trades_v2k1.json"], cwd=os.path.dirname(DATA_FILE), capture_output=True, timeout=10)
